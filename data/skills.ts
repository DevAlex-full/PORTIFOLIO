...
export const skills: Skill[] = [
  ...
  { name: 'React Native', icon: 'react',       level: 'intermediate', category: 'frontend' },
  ...
  { name: 'REST APIs',    icon: 'api',         level: 'advanced',     category: 'backend'  },
  ...
  { name: 'Supabase',     icon: 'supabase',    level: 'advanced',     category: 'database' },

  // ── DevOps / Deploy ──────────────────────────────────────────────────────────
  { name: 'Vercel',       icon: 'vercel',      level: 'advanced',     category: 'devops'   },
  { name: 'Render',       icon: 'render',      level: 'advanced',     category: 'devops'   },
  ...
  { name: 'N8N',          icon: 'n8n',         level: 'intermediate', category: 'tools'    },
